...
ALLOWED_HOSTS = os.environ.get(
    ...
    "* localhost 127.0.0.1 SERVERNAME"
).split()
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'webscraperdb0312'),
...
# STATIC FILES
# -----------------------------
STATIC_URL = '/webscraper/static/'

# Where Django will copy all static files for production
STATIC_ROOT = BASE_DIR / 'static'

# Where your source static files live (update path as per your project)
# STATICFILES_DIRS = [
